...
class weex(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        response = await self.publicGetPublicExchangeInfo(params)
        #
        #     {
        #       "code": "00000",
        #       "msg": "success",
    ...
    async def fetch_trades(self, symbol: Str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.publicGetMarketFills(self.extend(request, params))
        #
        #     {
        #         "code": "00000",
        #         "msg": "success",
    ...
    async def create_order(self, symbol: Str, type: OrderType, side: OrderSide, amount: Num, price: Num = None, params={}) -> Order:
        """
    ...
    async def cancel_order(self, id: Str, symbol: Str = None, params={}) -> Order:
        ...
        response = await self.privatePostTradeCancelOrder(self.extend(request, params))
        #
        #     {
        #       "code": "00000",
        #       "msg": "success",
    ...
    async def fetch_order(self, id: Str, symbol: Str = None, params={}) -> Order:
        ...
        if clientOrderId is not None:
            ...
            request['orderId'] = id
        params = self.omit(params, ['clientOrderId'])
        response = await self.privatePostTradeOrderInfo(self.extend(request, params))
        #
        #     {
        #       "code": "00000",
        #       "msg": "success",
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        response = await self.privatePostTradeOpenOrders(self.extend(request, params))
        #
        #     {
        #       "code": "00000",
        #       "msg": "success",
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if limit is not None:
            request['pageSize'] = limit
        response = await self.privatePostTradeFills(self.extend(request, params))
        #
        #     {
        #       "code": "00000",
        #       "msg": "success",
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None) -> dict:
        ...
        if api == 'public':
            ...
            message = timestamp + method.upper() + "/api/v2/" + path + queryString + (body or '')
